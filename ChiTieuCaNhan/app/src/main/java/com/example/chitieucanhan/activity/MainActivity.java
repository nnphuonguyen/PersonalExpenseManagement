...
//        medListAdapter.setUserData(appDatabase.medicineDao().getAllMedicine());
    ...
    private AlertDialog medicineAdder() {
        ...
        builder.setPositiveButton("EKLE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new InsertMedicineTask().execute(medicineEntity);
    ...
    private class InsertMedicineTask extends AsyncTask<MedicineEntity, Void, Long> {
        ...
        protected void onPostExecute(Long insertedId) {
            ...
            if (insertedId != -1) {
                ...
                Toast.makeText(MainActivity.this, "Lỗi khi thêm bản ghi", Toast.LENGTH_SHORT).show();
            }
        }
    }
